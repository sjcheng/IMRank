...
//					   }
	 ...
	 public boolean addDirectedEdge(DirectedEdge e)
	 {
		 ...
		 Node dest = e.getEndN();
		 if(!src.addLeader(dest)) return false;
//		 if(!dest.addneibor(src)) return false;
	 ...
	 public boolean removeDirectEdge(DirectedEdge e)
	 {
		 Node src = e.getStartN();
		 Node dest = e.getEndN();
		 if(!src.deleteLeader(dest)) return false;
		 if(!dest.deleteFan(src)) return false;
		 return true;
	 }
	 ...
	 {
		 if(!src.addLeader(dest)) return false;
		 if(!dest.addFan(src)) return false;
		 return true;
	 }
...
//		 try
//	        {
//	            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File(corenessFile))));
//	            String line ;
...
//		                 //if(this.getNodeByID(NodeID).getDegree()!=degree) System.out.println("wrong");
...
//		 try
//	        {
//	            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File(BCFile))));
//	            String line ;
//	            while((line=br.readLine())!=null)
//	            {
//	            	if(line.contains("#")) continue;
...
//	 }
	 ...
	 public static DirectedGraph ConstructFromFile(String filename)
	 {
	    return ConstructFromFile(new File(filename));
	  }
	 
	 public static DirectedGraph ConstructFromFile(File file)
	 {
	 ...
	 public static DirectedGraph ConstructFromUndirectedFile(String filename)
	 {
